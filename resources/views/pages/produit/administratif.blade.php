...
@section('contenu')         
    <div class="panel panel-success table-responsive ">
        <table class="table table-condensed table-bordered text-center" >
            ...
            {{ $produits->links()}}
      <p>Prix Officiels de la semaine <strong> {{setting('site.source')}} <a href="http://lejusteprix.info/images/decret.pdf">ici</a>
</strong></p>
@stop
@section('Modal')
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                  <div class="row col-md-12">
                       <iframe src=https://ee.humanitarianresponse.info/i/::b9tVcN26 width="100%" height="600"></iframe>
